...
import { faSchool, faGraduationCap, faBriefcase, faChessKnight, faMedal, faSquareRootAlt } from "@fortawesome/free-solid-svg-icons";

import userInfo from "../data/usersInfo.json";
import { before } from "lodash";
import MyTimeline from "../components/Timeline/timeline"; // Adjust the import path
                        ...
                        <div className="w-full md:w-[50%] ">
                            <div className={`w-full h-auto relative top-[20px] p-[10px] mb-[30px] md:mb-0 md:top-0`}>
                                ...
                                <div className={`relative top-[20px]`}>
                                    ...
                                    <br />
                                    <br />
                                    <p className={`text-[15px] text-white-200 p-2 px-5 bg-dark-400 border-l-[5px] border-solid border-l-green-200 italic`}>{userInfo.intro_tagline}</p>
                                    <br />

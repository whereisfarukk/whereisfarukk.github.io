    ...
    <div>
      ...
      <div className="w-screen h-auto ">
        ...
        <Container>
          ...
          >
            <h2 className="text-[20px] text-white-200 px-4 md:px-4 ">
              Personal Projects
            </h2>
          </div>
          ...
          <div
            id="head"
            className="w-full py-5 mx-auto flex flex-row justify-start items-start "
          >
      ...
      <div className="container mx-auto">
        <div className="project-preview grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {loading ? (
            ...
            repos.map((rep, i) => (
              <div
                className="card bg-dark-950 shadow-lg rounded-lg p-5 relative"
                key={i}
              >
                ...
                >
                  <a
                    href={`https://github.com/${rep.full_name}/stargazers`}
                    target="_blank"
                    rel="noreferrer"
                    className="flex items-center"
                  >
                    <span className="star_count">
                      {Number(rep.stargazers_count).toLocaleString()}
                    </span>{" "}
                    <StarIcon />
                  </a>
                </div>
                ...
                <p className="text-gray-400 description">
                  {rep.description && rep.description.length > 80
                    ? `${rep.description.slice(0, 80)}...`
                    : rep.description}
                </p>
                {rep.html_url && (
                  <a
                    ...
                    href={`https://github.com/whereisfarukk/${rep.slug}`}
                    target="_blank"
                    rel="noreferrer"
                  >
